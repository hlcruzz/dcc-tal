...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    try {
        ...
        $query = "INSERT INTO buildings (building_name,is_structured,latitude, longitude) VALUES (:building_name, :is_structured, :latitude, :longitude)";
        ...
        foreach ($_FILES['building_img']['name'] as $key => $file_name) {
            $temp_name = $_FILES['building_img']['tmp_name'][$key];
            $file_type = $_FILES['building_img']['type'][$key];
            $file_size = $_FILES['building_img']['size'][$key];
