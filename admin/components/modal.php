            ...
            <form id="add-academics-form" class="p-4 md:p-5" method="POST">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <p class="mt-1 text-[10px] text-gray-500 ">PNG, JPG, JPEG (MAX PER FILE : 5MB).</p>

                    </div>
                    <div class="col-span-2">
                        <label for="building_name" class="block mb-2 text-sm font-medium text-gray-900 ">Building
                            Name</label>
                    ...
                    <div class="col-span-2 flex items-center gap-3">
                        <p class="flex items-center text-sm text-gray-500 ">Is it structured?<button
                        ...
                        <div data-popover id="popover-is-structured" role="tooltip"
                            ...
                            <div class="p-3 space-y-2">
                                <h3 class="font-semibold text-gray-900">Is it structured?</h3>
                                ...
                                <h3 class="font-semibold text-gray-900">Purpose</h3>
                        ...
                        <input id="is_structured" name="is_structured" type="checkbox" value="1"
                            class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-green-500 ">
                ...
                <button type="button" id="get-location"
                    class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 w-full"><i
                        class="fa-solid fa-location-dot me-1 "></i>
                    Get Current Location
                </button>
                <button type="submit"
                    class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 w-full mt-3"><i
                        ...
                        <div class="relative w-full" data-carousel="slide">
                            ...
                            <div id="edit-academics-carousel-btn"
                                ...
                                <button type="button" class="w-3 h-3 rounded-full" aria-current="true"
                                    aria-label="Slide 1" data-carousel-slide-to="1"></button>
            ...
            <form id="add-facility-form" class="p-4 md:p-5" method="POST">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <label class="block mb-2 text-sm font-medium text-gray-900" for="facility_img">Upload
                            file</label>
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 "
                    ...
                    <div class="col-span-2">
                        <label for="facilityName" class="block mb-2 text-sm font-medium text-gray-900 ">Facility
                            Name</label>
                    ...
                    <div class="col-span-2">
                        <div class="flex items-center gap-3">
                            <label for="hasRoomNum" class="block text-sm font-medium text-gray-900 ">Has Room
                                Number?</label>
                    ...
                    <div class="col-span-2">
                        <div class="flex items-center gap-3">
                            <label for="hasFloorNum" class="block text-sm font-medium text-gray-900 ">Has Floor
                                Number?</label>
