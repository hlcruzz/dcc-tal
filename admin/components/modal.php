<!-- Main modal -->
<div id="add-academics-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="add-academics-modal">
...
<!-- Main modal -->
<div id="edit-academics-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-sm ">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-academics-modal">
                    <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    </svg>
            ...
            <form id="edit-academics-form" class="p-4 md:p-5" method="POST">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <div class="swiper mySwiper w-full h-96" id="edit-academics-swiper">
